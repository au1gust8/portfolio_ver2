$(document).ready(function () {
        ...
        $(window).on('scroll',function(){
            ...
            //스크롤의 거리의 범위를 처리
            if(scroll>=350 && scroll<1100){
                $('.subNav li:eq(0)').find('a').addClass('spy');
                $('#content .sec1').addClass('boxMove');
            }else if(scroll>=1100 && scroll<2000){
                $('.subNav li:eq(1)').find('a').addClass('spy');
                 $('#content .sec2').addClass('boxMove');
            }else if(scroll>=2000 && scroll<5300){
                $('.subNav li:eq(2)').find('a').addClass('spy');
                 $('#content div.sec3').addClass('boxMove');
            }else if(scroll>=5300 && scroll<7000){
